...
{
    [InitializeOnLoad]
    public class NewScriptDefaultPath : EditorWindow
    {
        ...
        static void Init()
        {
            var win = CreateInstance<NewScriptDefaultPath>();
        ...
        static NewScriptDefaultPath instance;
